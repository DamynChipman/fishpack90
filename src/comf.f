...
C                        DESCRIPTION OF ENTRIES EPMACH AND PI_MACH
C                        FOLLOW BELOW.
C
...
C September 2015    Renamed PIMACH -> PI_MACH to avoid conflicts with
